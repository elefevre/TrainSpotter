...
public class CheckTrainStatusServiceTest extends UnitTest {
	...
	public void shouldCheckStatusOfTrain() throws Exception {
		...
		when(mockTrainInformationPageDao.findAll()).thenReturn(Lists.<TrainInformationPage> newArrayList(//
				new TrainInformationPage("7000", "20/10/2011", Lists.<TrainStationStatus> newArrayList()),//
				new TrainInformationPage("8000", "22/10/2011", Lists.<TrainStationStatus> newArrayList())));
		when(mockStatusPageRetriever.downloadStatusPageForTrain("7000", 2011, 1, 1)).thenReturn(mockRecentTrainInformationPageFor7000);
		when(mockStatusPageRetriever.downloadStatusPageForTrain("8000", 2011, 1, 1)).thenReturn(mockRecentTrainInformationPageFor8000);
