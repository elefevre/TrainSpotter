...
public class TrainStatusNotifierTest extends UnitTest {
	...
	public void shouldSendAnEmailWhenThisIsTheFirstRequestForStatusForThisTrain() {
		...
		verify(mockTrainInformationPageDao).save(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00", "A l'heure"), new TrainStationStatus("Orléans", "11:00", "A l'heure"))));
	}

	@Test
	public void shouldNotSendAnEmailIfTheStatusHasNotChanged() {
		when(mockTrainInformationPageDao.find("7000")).thenReturn(newArrayList(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00", "A l'heure"), new TrainStationStatus("Orléans", "11:00", "A l'heure")))));
	...
	public void shouldSendAnEmailIfThereIsADifferenceNumberOfInformationFields() {
		...
		notifier.notify("user@site.com", "7000", new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00", "A l'heure"))));

		verify(mockEmailSender).sendEmail("user@site.com", "Train 7000", "Paris-Nord: 10:00 (A l'heure)", "ericlef@gmail.com");
		verify(mockTrainInformationPageDao).save(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00", "A l'heure"))));
	}

	@Test
	public void shouldSendAnEmailIfTheInformationFieldHasChanged() {
		when(mockTrainInformationPageDao.find("7000")).thenReturn(newArrayList(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00", "A l'heure WILL DE DIFFERENT")))));
	...
	public void shouldSendAnEmailIfTheTrainStationHasChanged() {
		when(mockTrainInformationPageDao.find("7000")).thenReturn(newArrayList(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord WILL DE DIFFERENT", "10:00", "A l'heure")))));
	...
	public void shouldSendAnEmailIfTheCallingTimeAtATrainStationHasChanged() {
		when(mockTrainInformationPageDao.find("7000")).thenReturn(newArrayList(new TrainInformationPage("7000", "20/10/2011", newArrayList(new TrainStationStatus("Paris-Nord", "10:00 WILL DE DIFFERENT", "A l'heure")))));
